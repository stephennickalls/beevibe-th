...
const handleAddHive = async (hiveData) => {
  ...
  try {
    ...
    // Set error on the composable - but clearError is read-only, so we need to handle this differently
    // For now, we'll create a local error state for this specific case
